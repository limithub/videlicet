...
fonts: [Barrio, "Londrina Sketch", Lato, Inconsolata]
resources: |
code: |
 ...
 h1,h2,h3,.splash h3, #omg blockquote {font-family:"Helvetica Neue",Helvetica, Arial, sans-serif !important; font-weight:900; color:rgba(0,0,0,0);text-align: center; text-transform: uppercase;
  ...
  p.next {clear:both}
  p.next span {font-size:0; opacity:0}
  ...
  .speechbubble(odd) {float:left;}
  #orientation {background:url(/assets/pics/posts/mashup/orientation.jpg); background-size:contain; background-repeat:no-repeat}
...
---
<section class="video fullscreen"><iframe width="560" height="315" src="https://www.youtube.com/embed/mmbsJ5t0vcg" frameborder="0" allowfullscreen></iframe></section>
...
<section class="slideshow fullscreen " id="screening">
...
<a href="http://fanlore.org/wiki/Data%27s_Dream">About</a></figcaption>
</figure>
</li>
...
<figcaption class="flexcaption" markdown="1">
...
<div class="fullscreen slideshow flexslider">
      <ul class="slides">
         <li>
...
<div class="slideshow flexslider">
      <ul class="slides">
        ...
        <li>
          <figure><iframe width="560" height="315" src="https://www.youtube.com/embed/memmE5xQw-c" frameborder="0" allowfullscreen></iframe>
            <figcaption>
