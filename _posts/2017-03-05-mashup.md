...
code: |
 ...
 h1,h2,h3,.splash h3, #omg blockquote {font-family:"Helvetica Neue",Helvetica, Arial, sans-serif !important; font-weight:900; color:rgba(0,0,0,0);text-align: center; text-transform: uppercase;
  ...
  .slideshow figure figcaption {position:absolute; top:1.5em; text-align:center; background-color:rgba(255,255,255,0.5); z-index:100; padding:0.5em}
  .slideshow figure.video figcaption {top:3em}
...
<div class="overhead mid copy" markdown="1">
