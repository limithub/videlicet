...
fonts: [Oswald, Limelight, Kristi]
tools: [youtube, typeset, scrollify]
resources: |
code: |
 header h2 {font-family:Limelight;}
 ...
 { font:3rem "Kristi",serif;font-size:5vw; top: 30%; transform:none; color:rgba(0,0,0,0.5)}
  #tiffany em {font:6vw "Limelight", monospace; { animation: neon 1.5s ease-in-out infinite alternate;}
...
<blockquote class="pullquote"><p>We have to go in there.</p></blockquote>
