...
pitch: |
 pitch
heading: |
 <span class="hsjs">How to</span> <span class="hsjs">Leave</span> <span class="hsjs">this</span> <span class="hsjs">Show</span>
hero: giphy-mirror-glitch.gif
fonts: [Oswald, Limelight]
tools: [youtube, typeset, scrollify]
resources: |
code: |
 #tiffany {background-image:url(/assets/pics/posts/show/giphy-mirror-glitch.gif)}
 #pink-climb {background-image:url(/assets/pics/posts/lyrical/pink-climb.gif)}
 .splash blockquote, .splash h2,.splash h3, .splash h4, .splash div 
{ font:3rem "Limelight",serif; padding:1rem; border:0; font-size:larger;text-shadow:1px 1px 0px #000;width:50%;position:absolute;top: 50%; left:50%; transform: translateY(-50%);  transform: translateX(-50%); perspective(1px) }

categories: [articles, vids]
---

<section class="typeset invert">
<p>
<span class="slabtext">Leaving the Show</span>
<span class="slabtext">Stultiloquentia</span>
<span class="slabtext" markdown="1">Vid: [You](http://archiveofourown.org/works/480121)</span>
<span class="slabtext">by lolachrome</span>
</p>
</section>
<div class="youtube-player" data-id="EOrftVRg4r0"></div>
...
<div class="youtube-player" data-id="jYpcFHtxm60"></div>
<div class="youtube-player" data-id="ofKaUCoBiyw"></div>
...
<blockquote><p>We have to go in there.</p></blockquote>
...
<section class="splash" id="tiffany"><blockquote class="splashquote">his spirit is too big, his dreams too bright</blockquote></section>
...
<div class="mask" id="gaga" markdown="1">
...
<section class="copy" markdown="1"> 
### Fig. 2: Kurt finds his mojo with a little help from Lady Gaga in Glee episode 2x18, "Born This Way."
...
<div class="image left">img in bed</div>
...
<section class="copy" markdown="1"> 
### Fig. 3: The evolution of Kurt’s personal style.
...
<div class="youtube-player" data-id="K2xN1oUiGoQ"></div>
